\chapter{Pinout}
\hypertarget{md_include_2_r_e_a_d_m_e}{}\label{md_include_2_r_e_a_d_m_e}\index{Pinout@{Pinout}}
\label{md_include_2_r_e_a_d_m_e_autotoc_md0}%
\Hypertarget{md_include_2_r_e_a_d_m_e_autotoc_md0}%


\hypertarget{md_include_2_r_e_a_d_m_e_autotoc_md1}{}\doxysection{\texorpdfstring{Motor Drive}{Motor Drive}}\label{md_include_2_r_e_a_d_m_e_autotoc_md1}
To save IO pins we use \doxylink{class_t_b6612_f_n_g}{TB6612\+FNG} (H-\/bridge) in conjunction with SN74\+LVC2\+G14 (Two-\/\+Way Schmitt Trigger Reverser) like below  \hypertarget{md_include_2_r_e_a_d_m_e_autotoc_md2}{}\doxysection{\texorpdfstring{Inertial Measuring Unit\+:}{Inertial Measuring Unit\+:}}\label{md_include_2_r_e_a_d_m_e_autotoc_md2}
In this project \href{https://invensense.tdk.com/wp-content/uploads/2015/02/MPU-6000-Datasheet1.pdf}{\texttt{ MPU6050}} is used as IMU.\hypertarget{md_include_2_r_e_a_d_m_e_autotoc_md3}{}\doxysubsection{\texorpdfstring{Power Managment 1 Config}{Power Managment 1 Config}}\label{md_include_2_r_e_a_d_m_e_autotoc_md3}
...
\end{DoxyCode}
\hypertarget{md_include_2_r_e_a_d_m_e_autotoc_md4}{}\doxysubsection{\texorpdfstring{Gyro and Accel Config}{Gyro and Accel Config}}\label{md_include_2_r_e_a_d_m_e_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{md_include_2_r_e_a_d_m_e_autotoc_md5}{}\doxysubsection{\texorpdfstring{Reading Values}{Reading Values}}\label{md_include_2_r_e_a_d_m_e_autotoc_md5}
...
\end{DoxyCode}
\hypertarget{md_include_2_r_e_a_d_m_e_autotoc_md6}{}\doxysubsection{\texorpdfstring{Gyro drift}{Gyro drift}}\label{md_include_2_r_e_a_d_m_e_autotoc_md6}
...
\end{DoxyCode}
 \hypertarget{md_include_2_r_e_a_d_m_e_autotoc_md7}{}\doxysubsection{\texorpdfstring{Enable Interrupt}{Enable Interrupt}}\label{md_include_2_r_e_a_d_m_e_autotoc_md7}
