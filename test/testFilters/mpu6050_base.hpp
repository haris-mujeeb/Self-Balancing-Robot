...
public:
  ...
  float angle_roll_gyro = 0;                ///< Roll angle calculated from sensor data
  float angle_roll_comp;
  float angle_pitch_acc = 0;           ///< Pitch angle based on accelerometer data
  float angle_pitch_gyro = 0;               ///< Pitch angle calculated from sensor data
  float angle_pitch_comp; 
